...
public class COBA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(0, 0, 169, 218);

        jButton2.setText("jButton2");
        getContentPane().add(jButton2);
        jButton2.setBounds(169, 0, 169, 218);

        jButton3.setText("jButton3");
        getContentPane().add(jButton3);
        jButton3.setBounds(340, 0, 169, 218);

        jButton4.setText("jButton4");
        getContentPane().add(jButton4);
        jButton4.setBounds(0, 218, 169, 218);

        jButton5.setText("jButton5");
        getContentPane().add(jButton5);
        jButton5.setBounds(169, 218, 169, 218);
