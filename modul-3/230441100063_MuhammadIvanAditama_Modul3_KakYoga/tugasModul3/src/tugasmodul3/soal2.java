...
public class soal2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(0, 101, 83));
        ...
        jLabel2.setText("FORM PEMBAYARAN SPP");
        jPanel2.add(jLabel2);
        ...
        cbJurusan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Teknik Komputer Jaringan", "Rekayasa Perangkat Lunak", "Animasi", "Akuntansi", "Tata Boga" }));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 400, 610, 180));
    ...
    private void btnBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBayarActionPerformed
        ...
        if(bayar<total){
            JOptionPane.showMessageDialog(null, "Uang anda kurang", "Peringatan", JOptionPane.ERROR_MESSAGE);
        }else{
...
//        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        tabel.setValueAt("", tabel.getSelectedRow(), 4);
