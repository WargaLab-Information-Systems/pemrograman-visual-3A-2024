...
public class PembayaranSPP1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setPreferredSize(new java.awt.Dimension(713, 2794));
        ...
        jLabel10.setText("Kelola Pembayaran SPP ");
        ...
        jLabel11.setText("Isi Terlebih Dahulu Data Diri");
        ...
        btntotal.setText("HitungPembayaran");
        ...
        btnpmbyrn.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
                        ...
                        .addGroup(panel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panel4Layout.createSequentialGroup()
                                ...
                                .addGroup(panel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(panel4Layout.createSequentialGroup()
                                        .addGap(66, 66, 66)
                                        .addComponent(btnpmbyrn, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(panel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(tfpmbyrn, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE))
        ...
        btnstatus.setFont(new java.awt.Font("Segoe UI Variable", 1, 12)); // NOI18N
        ...
        btnriwayat.setFont(new java.awt.Font("Segoe UI Variable", 1, 12)); // NOI18N
        ...
        panel1Layout.setVerticalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panel3, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(panel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(panel1Layout.createSequentialGroup()
...
if (januari.isSelected()) {
        statusPembayaranBulan[0] = true; // Menyimpan status pembayaran untuk bulan Januari
        januari.setVisible(false); // Menyembunyikan checkbox Januari
    }
    if (februari.isSelected()) {
        statusPembayaranBulan[1] = true; // Menyimpan status pembayaran untuk bulan Februari
        februari.setVisible(false); // Menyembunyikan checkbox Februari
    }
    if (maret.isSelected()) {
        statusPembayaranBulan[2] = true; // Menyimpan status pembayaran untuk bulan Maret
        maret.setVisible(false); // Menyembunyikan checkbox Maret
    }
    if (april.isSelected()) {
        statusPembayaranBulan[3] = true; // Menyimpan status pembayaran untuk bulan April
        april.setVisible(false); // Menyembunyikan checkbox April
    }
    if (mei.isSelected()) {
        statusPembayaranBulan[4] = true; // Menyimpan status pembayaran untuk bulan Mei
        mei.setVisible(false); // Menyembunyikan checkbox Mei
    }
    if (juni.isSelected()) {
        statusPembayaranBulan[5] = true; // Menyimpan status pembayaran untuk bulan Juni
        juni.setVisible(false); // Menyembunyikan checkbox Juni
    }
    if (juli.isSelected()) {
        statusPembayaranBulan[6] = true; // Menyimpan status pembayaran untuk bulan Juli
        juli.setVisible(false); // Menyembunyikan checkbox Juli
    }
    if (agustus.isSelected()) {
        statusPembayaranBulan[7] = true; // Menyimpan status pembayaran untuk bulan Agustus
        agustus.setVisible(false); // Menyembunyikan checkbox Agustus
    }
    if (september.isSelected()) {
        statusPembayaranBulan[8] = true; // Menyimpan status pembayaran untuk bulan September
        september.setVisible(false); // Menyembunyikan checkbox September
    }
    if (oktober.isSelected()) {
        statusPembayaranBulan[9] = true; // Menyimpan status pembayaran untuk bulan Oktober
        oktober.setVisible(false); // Menyembunyikan checkbox Oktober
    }
    if (november.isSelected()) {
        statusPembayaranBulan[10] = true; // Menyimpan status pembayaran untuk bulan November
        november.setVisible(false); // Menyembunyikan checkbox November
    }
    if (desember.isSelected()) {
        statusPembayaranBulan[11] = true; // Menyimpan status pembayaran untuk bulan Desember
        desember.setVisible(false); // Menyembunyikan checkbox Desember
    }
