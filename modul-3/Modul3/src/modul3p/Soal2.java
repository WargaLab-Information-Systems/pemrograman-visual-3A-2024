...
public class Soal2 extends javax.swing.JFrame {
    int x = 0;
    Icon icon = new javax.swing.ImageIcon(getClass().getResource("/modul3P/icons8-success-48.png"));
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\HP VICTUS\\Downloads\\P E M B A Y A R A N S P P.png")); // NOI18N
        ...
        Kelas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilihan Kelas", "X-A", "X-B", "X-C", "XI-A", "XI-B", "XI-C", "XII-A", "XII-B", "XII-C" }));
        jPanel7.add(Kelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 94, 100, -1));
    ...
    private void HitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HitungActionPerformed
        ...
        int jumlahbulan = 0;
        String Tampil = "";
        String PilKelas  = Kelas.getSelectedItem().toString();
        
        if(PilKelas == "Pilihan Kelas"){
            JOptionPane.showMessageDialog(this, "SILAHKAN PILIHLAH KELASSS", "WARNING!!!!", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void BayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BayarActionPerformed
        ...
        if(cash < totalHarga){
            ...
            JOptionPane.showMessageDialog(this, "Pembayaran Suksesss","PERINGATAN!!!", JOptionPane.WARNING_MESSAGE,icon);
        }
