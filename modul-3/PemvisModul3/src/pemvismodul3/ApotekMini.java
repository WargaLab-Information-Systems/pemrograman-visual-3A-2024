...
public class ApotekMini extends javax.swing.JFrame {
    ...
    private void penghitungan() {
        try {
            double uangtotal = Double.parseDouble(tftotal.getText()); // Total harga yang baru
            double uangmasuk = Double.parseDouble(tfcash.getText()); // Uang yang sudah dimasukkan
            double kembalian = uangmasuk - uangtotal;
    ...
    private void btntotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntotalActionPerformed
        // TODO add your handling code here:
        if (!obat1.isSelected() && !obat2.isSelected() && !obat3.isSelected() && !obat4.isSelected() && !obat5.isSelected() && !obat6.isSelected() && !obat7.isSelected() && !obat8.isSelected() && !obat9.isSelected() && !obat10.isSelected()) {
        JOptionPane.showMessageDialog(null, "Anda harus memilih setidaknya satu obat terlebih dahulu!", "Peringatan", JOptionPane.WARNING_MESSAGE);
        return;
    }
